...
class PDF extends FPDF {
	function Header(){
		...
		$this->Ln(5);
		$this->Cell(155	,5,'Income Categories List',0,1,'C');
		...
		$this->Cell(80,10,'Income Category',1,0,'',true);
...
$pdf->AddPage();
$pdf->SetTitle('Income Categories List');

$pdf->SetFont('Arial','',10);
$pdf->SetDrawColor(0,0,0);

$query = mysqli_query($conn,"SELECT * FROM tbl_income_categories");
...
$pdf->Output('I','Income Categories List.pdf');
?>